...
const restartPlaybackManager = async () => {
    ...
    */
    ...
    const player = new Player(current_song, next_song, access_token);

    await player.gatherData();

    const analysis_fetch_ms = player.analysis_fetch_ms;
    const state_fetch_ms = player.state_fetch_ms;
